<?php /* Smarty version Smarty-3.1.16, created on 2015-08-31 00:21:43
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
	        <li class="click" onclick="location.href='admin.php?c=Article&m=add'"><span><img src="Tpl/admin/images/t01.png" /></span>添加</li>
	        <!--<li class="click"><span><img src="Tpl/admin/images/t02.png" /></span>修改</li>-->
	        <li><span><img src="Tpl/admin/images/t02.png" /></span>显示</li>
	        <li><span><img src="Tpl/admin/images/t02.png" /></span>隐藏</li>
...
em;"><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->getVariable('smarty')->value['section']['article']['index']]['categoryName'];?>
		        ...
		        <td><a class='tablelink' href="">显示</a>&nbsp;&nbsp;<a href="" class="tablelink">编辑</a>&nbsp;&nbsp;<a class='tablelink del' href="admin.php?c=Article&m=del&id=<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->getVariable('smarty')->value['section']['article']['index']]['id'];?>
