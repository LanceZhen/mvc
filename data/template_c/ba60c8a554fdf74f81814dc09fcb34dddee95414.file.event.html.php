			 ...
			 <div class="event-grids">
					<div class="col-md-3 event-grid">
						...
						<ul>
							...
							<li class="date2">2 December 2014</li>
						</ul>
					...
					<div class="col-md-3 event-grid text-button">
						<ul>
							<li class="num">300 tickets Available</li>
			  ...
			  <div class="event-grids">
					...
					<div class="col-md-2 event-grid large-text">
						<p class="text">$ 350 USD</p>
					</div>
					<div class="col-md-3 event-grid text-button">
						<ul>
							<li class="num">150 tickets Available</li>
							<li class="button yellow"><a href="#">Buy Ticket</a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>
			  ...
			  <div class="event-grids">
					...
					<div class="col-md-2 event-grid large-text">
						<p class="text">$ 500 USD</p>
					</div>
					<div class="col-md-3 event-grid text-button">
						<ul>
							<li class="num">75 tickets Available</li>
							<li class="button yellow"><a href="#">Buy Ticket</a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>
